         ...
         try:  
            ...
            for trace_id in final_vardf_base_straight['Tracebility ID'].unique():
                ...
                for index_tmp,row_tmp in interim_templatedf_base_straight.iterrows():
                    ...
                    basedf_straight=basedf_straight.append(pd.DataFrame([[trace_id,qstr_base_straight,'SOURCE','STRAIGHT','BASE',row_tmp['Test case Category'],row_tmp['Expected Result']]],columns=['Tracebility ID','TestCase','TargetXLSTab','ProcessCategory','Query Type','Test case Category','Expected Result']), ignore_index=True)      
...
#                 print trace_cmp_id              
                for index,row_cmp_tmp in interim_templatedf_compare_straight.iterrows():
                    ...
                    comparedf_straight=comparedf_straight.append(pd.DataFrame([[trace_cmp_id,qstr_cmp_straight,'TARGET','STRAIGHT','COMPARE',row_cmp_tmp['Test case Category'],row_cmp_tmp['Expected Result']]],columns=['Tracebility ID','TestCase','TargetXLSTab','ProcessCategory','Query Type','Test case Category','Expected Result']), ignore_index=True)
...
#             if not(final_vardf_base_default.empty and final_vardf_comapre_default.empty):
            ...
            for trace_id in final_vardf_base_default['Tracebility ID'].unique():
                ...
                for index_tmp,row_tmp in interim_templatedf_base_default.iterrows():
                    ...
                    #print qstr_base_straight
                    basedf_default=basedf_default.append(pd.DataFrame([[trace_id,qstr_base_default,'TARGET','DEFAULT','BASE',row_tmp['Test case Category'],row_tmp['Expected Result']]],columns=['Tracebility ID','TestCase','TargetXLSTab','ProcessCategory','Query Type','Test case Category','Expected Result']), ignore_index=True)      
...
#                             print row_cmp_var['QuerySequenceNo']
                    ...
                    comparedf_default=comparedf_default.append(pd.DataFrame([[trace_cmp_id,qstr_cmp_default,'TARGET','DEFAULT','COMPARE',row_cmp_tmp['Test case Category'],row_cmp_tmp['Expected Result']]],columns=['Tracebility ID','TestCase','TargetXLSTab','ProcessCategory','Query Type','Test case Category','Expected Result']), ignore_index=True)
                ...
                for index_tmp,row_tmp in interim_templatedf_base_rdm.iterrows():
                    ...
                    for ctr in range(0,basedflen-sub_start_point):
                        ...
                        if match==0:
                            qstr_base_straight=qstr_base_straight + ' ' + str(row_tmp[ctr+sub_start_point]).strip()
                    #print qstr_base_straight
                    basedf_rdm=basedf_rdm.append(pd.DataFrame([[trace_id,qstr_base_straight,'SOURCE','RDM JOIN TRANSFORM','BASE',row_tmp['Test case Category'],row_tmp['Expected Result']]],columns=['Tracebility ID','TestCase','TargetXLSTab','ProcessCategory','Query Type','Test case Category','Expected Result']), ignore_index=True)
...
#                             print row_cmp_var['QuerySequenceNo']
                    ...
                    comparedf_rdm=comparedf_rdm.append(pd.DataFrame([[trace_cmp_id,qstr_cmp_straight,'TARGET','RDM JOIN TRANSFORM','COMPARE',row_cmp_tmp['Test case Category'],row_cmp_tmp['Expected Result']]],columns=['Tracebility ID','TestCase','TargetXLSTab','ProcessCategory','Query Type','Test case Category','Expected Result']), ignore_index=True)
        ...
        try:  
            ...
            for trace_id in final_vardf_base_gen['Tracebility ID'].unique():
                ...
                for index_tmp,row_tmp in interim_templatedf_base_gen.iterrows():
                    ...
                    basedf_gen=basedf_gen.append(pd.DataFrame([[trace_id,qstr_base_gen,'SOURCE','GENERIC','BASE',row_tmp['Test case Category'],row_tmp['Expected Result']]],columns=['Tracebility ID','TestCase','TargetXLSTab','ProcessCategory','Query Type','Test case Category','Expected Result']), ignore_index=True)
...
#                             print row_cmp_var['QuerySequenceNo']
                    ...
                    comparedf_gen=comparedf_gen.append(pd.DataFrame([[trace_cmp_id,qstr_cmp_gen,'TARGET','GENERIC','COMPARE',row_cmp_tmp['Test case Category'],row_cmp_tmp['Expected Result']]],columns=['Tracebility ID','TestCase','TargetXLSTab','ProcessCategory','Query Type','Test case Category','Expected Result']), ignore_index=True)
...
#                                     print str(row_var['Value']).strip()
                        ...
                        basedf_transfm=basedf_transfm.append(pd.DataFrame([[trace_id,qstr_base_transfm,'SOURCE','SIMPLE TRANSFORM','BASE',row_tmp['Test case Category'],row_tmp['Expected Result']]],columns=['Tracebility ID','TestCase','TargetXLSTab','ProcessCategory','Query Type','Test case Category','Expected Result']), ignore_index=True)
...
#                                     print str(row_var_cmp['Value']).strip()
                        ...
                        comparedf_transfm=comparedf_transfm.append(pd.DataFrame([[trace_id_cmp,qstr_cmp_transfm,'TARGET','SIMPLE TRANSFORM','COMPARE',row_tmp_cmp['Test case Category'],row_tmp_cmp['Expected Result']]],columns=['Tracebility ID','TestCase','TargetXLSTab','ProcessCategory','Query Type','Test case Category','Expected Result']), ignore_index=True)                        
